...
function MemberHomeWeb() {
  ...
  const { sessionsThisMonth, timeThisMonth, lastSessionLabel } = useMemo(() => {
    ...
    return {
      ...
      lastSessionLabel: logs[0]
        ? relativeFromNow(logs[0].completed_at, now)
        : null,
    };
  }, [logs, now]);
                ...
                >
                  ...
                  <View
                    style={{
                      ...
                      height: 3,
                      borderRadius: 2,
                      backgroundColor: "rgba(42,232,204,0.4)",
                    }}
                  />
                </View>
          ...
          >
              ...
              >
                ...
                <View
                  style={{
                    ...
                    width: 10,
                    height: 3,
                    backgroundColor: "rgba(42,232,204,0.35)",
                    borderRadius: 2,
                  }}
                />
                ...
                {logsLoading ? (
                  ...
                  >
                    ...
                    >
                      <View
                        style={{
                          ...
                          height: 4,
                          borderRadius: 2,
                          backgroundColor: "rgba(15,13,32,0.25)",
                        }}
                      />
                      <Text
                        style={{
                    ...
                    >
                      Cuando termines una sesión en el móvil, vas a ver acá tu
                      progreso reciente.
                    </Text>
                  </View>
                ) : (
                        ...
                        >
                          ...
                          <View
                            style={{
                              ...
                              borderWidth: 1,
                              borderColor: "rgba(48,35,205,0.1)",
                            }}
                          >
                            <Text
                              style={{
            ...
            <View style={{ flex: 1 }}>
              ...
              >
                ...
                >
                  El entrenamiento más efectivo es el que hacés seguido, no el
                  que hacés perfecto.
                </Text>
              </View>
            </View>
    ...
    >
      ...
      <View style={{ flex: 1 }}>
        <Text
          style={{
            fontSize: 9,
            fontFamily: "Manrope_700Bold",
            color: isPrimary ? MINT_DARK : "rgba(15,13,32,0.38)",
            letterSpacing: 1.6,
            textTransform: "uppercase",
            marginBottom: 2,
          }}
      ...
      <View
        style={{
          ...
          borderColor: "rgba(15,13,32,0.09)",
          alignItems: "center",
          justifyContent: "center",
        }}
      >
        <ChevronRight
          size={13}
          color={isPrimary ? P600 : "rgba(15,13,32,0.45)"}
        />
      </View>
    </Pressable>
  );
