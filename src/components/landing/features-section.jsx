    ...
    <View className="w-full">
      <View className="w-full max-w-[1200px] mx-auto px-6 py-20">
        ...
        <View className="items-center mb-14">
          <Text className="text-[#2DD4BF] font-manrope-bold text-sm tracking-widest uppercase mb-3">
            Beneficios
          </Text>
          ...
          <Text className="text-[#c2c1ff] font-manrope text-base mt-4 text-center max-w-[560px] leading-relaxed">
        ...
        <View className="flex-row flex-wrap -mx-3">
          {FEATURES.map((feature) => (
            <View key={feature.title} style={{ width: cardWidth }} className="p-3">
              <View className="h-full rounded-3xl bg-white/5 border border-white/10 p-7 hover:bg-white/[0.08] hover:border-[#4a44e4]/40 transition">
                <View className="w-12 h-12 rounded-2xl bg-[#4a44e4]/20 border border-[#4a44e4]/30 items-center justify-center mb-5">
                  <LandingIcon name={feature.icon} size={24} color="#2DD4BF" />
                </View>
                <Text className="text-white font-jakarta-bold text-xl mb-2.5">
                  {feature.title}
                </Text>
                <Text className="text-[#c2c1ff] font-manrope text-[15px] leading-relaxed">
                  {feature.description}
                </Text>
              </View>
            </View>
