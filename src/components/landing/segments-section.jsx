          ...
          {SEGMENTS.map((segment) => (
            ...
            >
              <View className="flex-row items-center mb-5">
                <View className="w-12 h-12 rounded-2xl bg-[#2DD4BF]/15 border border-[#2DD4BF]/30 items-center justify-center mr-4">
                  <LandingIcon name={segment.icon} size={24} color="#2DD4BF" />
                </View>
              ...
              <Text className="text-[#c2c1ff] font-manrope text-base leading-relaxed mb-6">
                {segment.description}
              </Text>
              ...
              <View className="gap-3">
                {segment.points.map((point) => (
                  <View key={point} className="flex-row items-center">
                    <CheckCircle color="#2DD4BF" size={20} />
