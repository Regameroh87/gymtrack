...
ALTER TABLE `equipment` ADD `local_image_uri` text NOT NULL;--> statement-breakpoint
...
ALTER TABLE `exercises_base` ADD `local_image_uri` text NOT NULL;--> statement-breakpoint
ALTER TABLE `exercises_base` ADD `local_video_uri` text NOT NULL;--> statement-breakpoint
