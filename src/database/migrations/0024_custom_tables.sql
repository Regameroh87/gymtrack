...
--> statement-breakpoint
CREATE UNIQUE INDEX `custom_session_exercises_session_id_exercise_id_unique` ON `custom_session_exercises` (`session_id`,`exercise_id`);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `custom_plan_weeks_plan_id_week_number_unique` ON `custom_plan_weeks` (`plan_id`,`week_number`);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `custom_plan_week_days_week_id_day_number_unique` ON `custom_plan_week_days` (`week_id`,`day_number`);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `custom_plan_week_day_exercises_week_day_id_session_exercise_id_unique` ON `custom_plan_week_day_exercises` (`week_day_id`,`session_exercise_id`);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `custom_plan_week_day_exercise_sets_exercise_id_set_number_unique` ON `custom_plan_week_day_exercise_sets` (`exercise_id`,`set_number`);
