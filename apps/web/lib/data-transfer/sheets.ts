...
export const LEEME_AOA: unknown[][] = [
  ...
  [],
  ["Ejercicios:"],
  ["- Categoría: Fuerza, Cardio, Flexibilidad, Potencia, Isométrico o Hipertrofia."],
  ["- Grupo muscular: Pecho, Espalda, Deltoides anterior, Deltoides lateral, Deltoides posterior, Bíceps, Tríceps, Cuádriceps, Glúteos, Femorales, Gemelos, Tibiales, Aductores o Core."],
