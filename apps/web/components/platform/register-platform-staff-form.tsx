...
// Form de alta de staff de plataforma (superadmin_admin / superadmin_coach).
// Mismo perfil que admin/users/register/page.tsx (foto, teléfono, documento,
// dirección, género); solo cambia el rol asignable (PLATFORM_ASSIGNABLE_ROLES
// del caller) y la edge function de alta (crear-staff-plataforma, sin gym).
...
export function RegisterPlatformStaffForm() {
    ...
    onSubmit: async ({ value }) => {
      try {
        ...
        const response = await supabase.functions.invoke("crear-staff-plataforma", {
          body: { ...value, role, image_profile, gender: value.gender || null },
        });
