...
export const Users = ({ size = 24, className, ...props }) => (
  ...
  >
    <Path stroke="none" d="M0 0h24v24H0z" />
    <Path d="M9 7a4 4 0 1 0 8 0 4 4 0 0 0-8 0M3 21v-2a4 4 0 0 1 4-4h4a4 4 0 0 1 4 4v2M16 3.13a4 4 0 0 1 0 7.75M21 21v-2a4 4 0 0 0-3-3.85" />
  </Svg>
);

export const ClipboardList = ({ size = 24, className, ...props }) => (
  <Svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
  ...
  >
    ...
    <Path d="M9 3a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v0a2 2 0 0 1-2 2h-2a2 2 0 0 1-2-2zM9 12h.01M13 12h2M9 16h.01M13 16h2" />
  </Svg>
);

export const Receipt = ({ size = 24, className, ...props }) => (
  <Svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
    ...
    strokeLinejoin="round"
    strokeWidth={2}
    className={`icon icon-tabler icons-tabler-outline icon-tabler-receipt ${className}`}
    {...props}
  >
    <Path stroke="none" d="M0 0h24v24H0z" />
...
export const ChartBar = ({ size = 24, className, ...props }) => (
  <Svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const Filter = ({ size = 24, className, ...props }) => (
  ...
  >
    <Path stroke="none" d="M0 0h24v24H0z" />
    <Path d="M4 4h16v2.172a2 2 0 0 1-.586 1.414L13 14v7l-2-2v-5L4.586 7.586A2 2 0 0 1 4 6.172V4z" />
  </Svg>
);
...
export const CameraPlus = ({ size = 24, className, ...props }) => (
  <Svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
    ...
    strokeLinejoin="round"
    strokeWidth={2}
    className={`icon icon-tabler icons-tabler-outline icon-tabler-camera-plus ${className}`}
    {...props}
  >
    <Path stroke="none" d="M0 0h24v24H0z" />
...
export const CloudUpload = ({ size = 24, className, ...props }) => (
  <Svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
    ...
    strokeLinejoin="round"
    strokeWidth={2}
    className={`icon icon-tabler icons-tabler-outline icon-tabler-cloud-upload ${className}`}
    {...props}
  >
    <Path stroke="none" d="M0 0h24v24H0z" />
...
export const CheckCircle = ({ size = 24, className, ...props }) => (
  ...
  >
    <Path stroke="none" d="M0 0h24v24H0z" />
    <Path d="M3 12a9 9 0 1 0 18 0 9 9 0 0 0-18 0M9 12l2 2 4-4" />
  </Svg>
);
...
export const Walk = ({ size = 24, className, ...props }) => (
  <Svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
    ...
    strokeLinejoin="round"
    strokeWidth={2}
    className={`icon icon-tabler icons-tabler-outline icon-tabler-walk ${className}`}
    {...props}
  >
    <Path stroke="none" d="M0 0h24v24H0z" />
    <Path d="M13 4m-1 0a1 1 0 1 0 2 0 1 1 0 1 0-2 0" />
    <Path d="M7 21l3-4M16 21l-2-4-3-3 1-6" />
